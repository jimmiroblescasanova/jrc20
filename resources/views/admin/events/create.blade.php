<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border p-5 overflow-x-auto shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.events.store') }}" method="post" enctype="multipart/form-data">
                    @csrf   
                    <x-input-icon name="title" label="Ingresa el titulo del evento">
                    ...
                    <x-input-icon name="subtitle" label="Ingresa el subtitulo o expositor" placeholder="Ej. Jimmi Robles">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-gray-500 w-5 h-5">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-5.5-2.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM10 12a5.99 5.99 0 00-4.793 2.39A6.483 6.483 0 0010 16.5a6.483 6.483 0 004.793-2.11A5.99 5.99 0 0010 12z" clip-rule="evenodd" />
                        </svg>
                    </x-input-icon>
                    <x-input-icon type="datetime-local" name="date" label="Fecha del evento">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-gray-500 w-5 h-5">
