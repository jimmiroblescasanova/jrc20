    ...
    <x-slot name="header">
        <div class="w-full inline-flex justify-between">
            ...
            <a href="{{ route('admin.events.create') }}"
                class="p-2 text-white bg-indigo-500 hover:bg-indigo-800 rounded transition-colors">
                Nuevo evento</a>
        </div>
    </x-slot>
                ...
                <x-table>
                    ...
                    @forelse ($events as $event)
                        <tr class="border-b">
                            ...
                            <x-table.row>
                                <a href="{{ route('admin.events.show', $event) }}" class="text-white text-sm py-1 px-2 transition-colors rounded bg-indigo-400 hover:bg-indigo-700 inline-flex items-center">
